...
const experiences = [
    ...
    },
    {
        ...
        desc: `Na Agência Agile, atuei no desenvolvimento front-end de sites institucionais, criando interfaces responsivas e otimizadas com CSS, JavaScript e jQuery. Fui responsável por transformar layouts do Figma em código limpo e eficiente, aplicando técnicas de performance e animações suaves. <br/><br/>
    Participei do desenvolvimento de projetos como 
    <a href="https://jeracapital.com.br/" target="_blank" rel="noopener noreferrer" class="text-blue-500 hover:underline font-medium">Jera Capital</a>, 
    <a href="https://editacast.com.br/" target="_blank" rel="noopener noreferrer" class="text-blue-500 hover:underline font-medium">EditaCast</a> e 
    <a href="https://www.agropalma.com.br/" target="_blank" rel="noopener noreferrer" class="text-blue-500 hover:underline font-medium">Agropalma</a>, 
    contribuindo para interfaces modernas e funcionais que reforçam a identidade digital das marcas.`
    }
]
        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {experiences.map((exp, i) => (
                    <div
                        key={i}
                        className="rounded-xl p-6 surface-light dark:surface-dark shadow-sm hover:shadow-md transition"
                    >
